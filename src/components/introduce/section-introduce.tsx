        ...
        <div id="src-intro" className="section-intro">
            ...
            <div className="wrap">
                ...
                <p className="itr-txt" data-aos="fade-up">
                    ...
                    책임감은 저 스스로를 채찍질하여 좋은 퀄리티의 결과물을 만들어내고 팀원과의 원활한 커뮤니케이션과 조율을 이끌어낼 수 있는, 저에게 주어진 최고의 아드레날린이라 생각하기 때문입니다.<br/>
                    그렇기에 저는 프로젝트가 종료된 후, 훗날 향상된 실력을 가진 제가 저를 뒤돌아 보았을 때 부끄럽지 않은 모습으로 보일 수 있도록 책임감을 가지고 업무에 임하고 있습니다. <br/><br/>
